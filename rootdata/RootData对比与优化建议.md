...
| Based (标杆) | TermiX (当前) |
| :--- | :--- |
| ![Based Overview](based/overview.png) | ![TermiX Overview](termix/overview.png) |
...
| Based (标杆) | TermiX (当前) |
| :--- | :--- |
| ![Based Team](based/team.png) | ![TermiX Team](termix/team.png) |
...
| Based (标杆) | TermiX (当前) |
| :--- | :--- |
| ![Based Detail](based/detail.png) | ![TermiX Details](termix/details.png) |
...
| Based (标杆) | TermiX (当前) |
| :--- | :--- |
| ![Based News](based/relatedNews.png) | **[缺失板块]** |
...
**Based 关注度更新与列表**
![Based X Updates](based/XFollowUpdates.png) ![Based X Lists](based/XFollowLists.png)

**TermiX 关注度更新与列表**
![TermiX X Updates](termix/XFollowUpdates.png) ![TermiX X Lists](termix/XFollowList.png)
...
| Based (标杆) | TermiX (当前) |
| :--- | :--- |
| ![Based Performance](based/performances.png) ![Based NetChart](based/netChart.png) | ![TermiX Performance](termix/performances.png) |
...
![Based Tokenomics](based/tokenomics.png)
![Based Event Calendar](based/eventCalendar.png)
...
**文档位置与资源说明:**
- 本文档使用相对路径引用 `based/` 和 `termix/` 文件夹下的所有截图。
- 若要在其他设备查看图表，请确保整个 `rootdata/` 文件夹结构完整。
